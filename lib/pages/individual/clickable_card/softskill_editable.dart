...
class SoftSkillEdit extends StatefulWidget {
  final Map basic;
  SoftSkillEdit({this.basic});
  @override
  _SoftSkillEditState createState() => _SoftSkillEditState();
}

class _SoftSkillEditState extends State<SoftSkillEdit> {
  String name = "";
//  String id = "285885";
