...
class HealthEditCard extends StatefulWidget {
  HealthEditCard({this.data, this.index});

  int index;
  GetOtherVaccineModel data;

  @override
  _HealthEditCardState createState() => _HealthEditCardState();
}

class _HealthEditCardState extends State<HealthEditCard> {
                            ...
                            children: [
                              ...
                              Center(
                                child: CircleAvatar(
                                  ...
                                  child: CircleAvatar(
                                    backgroundImage:
                                        AssetImage("assets/images/covi.png"),
                                    radius: 70,
