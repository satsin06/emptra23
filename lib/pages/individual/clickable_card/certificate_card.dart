...
class CertificateEditCard extends StatefulWidget {

  CertificateEditCard({this.data,this.index});
  int index;
  GetCertificateModel data;

  @override
  _CertificateEditCardState createState() => _CertificateEditCardState();
}

class _CertificateEditCardState extends State<CertificateEditCard> {
  ...
  uploadDoc(String url) async {
    ...
    Map data = {
      ...
      "organizationName":widget.data.result[widget.index].organizationName.toString(),
  ...
  _deleteCertificate({String id}) async {
    setState(() {
      _isLoading = true;
    });
    var dio = Dio();
    var response = await dio.delete(
      "${Api.deleteCertifcate}/$id",
      options: Options(headers: {
        HttpHeaders.contentTypeHeader: "application/json",
        "token": "kxizbm3c5q1n804k3njinru7wuytrya5",
        "versionnumber": "v1"
