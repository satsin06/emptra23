...
class PermanentAdd extends StatefulWidget {
  @override
  _PermanentAddState createState() => _PermanentAddState();
}

class _PermanentAddState extends State<PermanentAdd> {
  String name = "";
    ...
    if (response.statusCode == 200) {
      if (response.data['code'] == 100) {
        setState(() {
          ...
          _houseNo.text = _permanentAddress.result[0].house.toString() == null
              ? ''
              : _houseNo.text = _permanentAddress.result[0].house.toString();

          _areaAdd.text = _permanentAddress.result[0].area.toString() == null
              ? ''
              : _areaAdd.text = _permanentAddress.result[0].area.toString();

          _landMark.text =
              _permanentAddress.result[0].landmark.toString() == null
                  ? ''
                  : _landMark.text =
                      _permanentAddress.result[0].landmark.toString();

          _cityAdd.text = _permanentAddress.result[0].city.toString() == null
              ? ''
              : _cityAdd.text = _permanentAddress.result[0].city.toString();

          _stateAdd.text = _permanentAddress.result[0].state.toString() == null
              ? ''
              : _stateAdd.text = _permanentAddress.result[0].state.toString();

          _countryAdd.text =
              _permanentAddress.result[0].country.toString() == null
                  ? ''
                  : _countryAdd.text =
                      _permanentAddress.result[0].country.toString();
      ...
      if (response.data['code'] == 100) {
        setState(() {
          Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                  builder: (BuildContext context) => AddressCard()));
          _isLoading = false;
