...
class VaccinationUploadDoc extends StatefulWidget {
  @override
  _VaccinationUploadDocState createState() => _VaccinationUploadDocState();
}

class _VaccinationUploadDocState extends State<VaccinationUploadDoc> {
