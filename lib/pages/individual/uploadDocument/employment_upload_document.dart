...
class EmployementUploadDoc extends StatefulWidget {
  final String id,companyName;
  EmployementUploadDoc({this.id, this.companyName});

  @override
  _EmployementUploadDocState createState() => _EmployementUploadDocState();
}

class _EmployementUploadDocState extends State<EmployementUploadDoc> {
  ...
  uploaddoc(String url) async {
    ...
    // session.setString("_id", "618102b60a66c5350ab560fe");
    // String _id = session.getString("_id");
    // print("$_id+++++++++++++++++++++++++++++++++++");
    // String _id = response.data['result']['_id'];
    ...
    Map data = {
    "userId": userId,
    "organizationId": widget.id, //prajeet bhai yaha pr le aao .. ki yaha map krva do
    "organizationName": widget.companyName,// prajeet bhai yaha pr le aao  ki yaha map krva do
    "docType": "employment",
    "docUrl": url,
