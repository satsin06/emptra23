...
class CourseUploadDoc extends StatefulWidget {
  @override
  _CourseUploadDocState createState() => _CourseUploadDocState();
}

class _CourseUploadDocState extends State<CourseUploadDoc> {
