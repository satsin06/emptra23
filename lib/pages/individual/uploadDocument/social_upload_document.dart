...
class SocialUploadDoc extends StatefulWidget {
  @override
  _SocialUploadDocState createState() => _SocialUploadDocState();
}

class _SocialUploadDocState extends State<SocialUploadDoc> {
