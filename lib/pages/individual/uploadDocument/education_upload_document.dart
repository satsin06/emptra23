...
class EducationUploadDoc extends StatefulWidget {
  final String id,companyName;
  EducationUploadDoc({this.id, this.companyName});
  @override
  _EducationUploadDocState createState() => _EducationUploadDocState();
}

class _EducationUploadDocState extends State<EducationUploadDoc> {
  ...
  uploaddoc(String url) async {
    ...
    Map data = {
      ...
      "organizationName": widget.companyName,
      "docType": "employment",
      "docUrl": url,
